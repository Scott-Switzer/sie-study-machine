var SIE_QUESTIONS_YOUTUBE_CA3 = [
 {
  "id": "yt-ca3-1",
  "section": "1 - Capital Markets",
  "stem": "Which of the following is NOT a type of municipal security?",
  "choices": {
 ...
 },
 {
  ...
  "stem": "A registered representative is approached by their friend, who wants to raise capital for the small business they just started. The friend knows the registered representative has extensive experience with securities and offers to pay them for their services. What statement is true?",
  "choices": {
   "A": "The firm is required to keep the details of the transaction on record",
   "B": "All of these choices",
   "C": "The representative must verbally notify their firm",
 ...
 },
 {
  ...
  "stem": "Which is the most common reason for market price fluctuations of bonds?",
  "choices": {
   "A": "Tax law changes",
   "B": "Stock market values",
   "C": "Conversion rates of bonds",
 ...
 },
 {
  "id": "yt-ca3-24",
  "section": "2 - Products & Risks",
  "stem": "Freddie Mac purchases what kind of mortgages from banks?",
  "choices": {
   "A": "FHA and VA insured mortgages",
   "B": "Sub-prime mortgages",
   "C": "FHA, VA and conventional mortgages",
 ...
 },
 {
  "id": "yt-ca3-55",
  "section": "2 - Products & Risks",
  "stem": "If a fund has 75% of its assets invested, no more than 5% in any one issue, and no more than 10% voting power in one issue, it is considered which of the following?",
  "choices": {
   "A": "Negotiable",
   "B": "Registered",
   "C": "Convertible",
